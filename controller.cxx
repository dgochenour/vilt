...
rtiddsgen -language C++11 -example <arch> ProximityDatatype.idl

Example subscription of type ProximityData automatically generated by 
...
int subscriber_main(int domain_id, int sample_count)
{
    ...
    dds::topic::Topic<ProximityData> topic(participant, "Example ProximityData");

    // Create a DataReader with default Qos (Subscriber created in-line)
    dds::sub::DataReader<ProximityData> reader(dds::sub::Subscriber(participant), topic);
    ...
    while (count < sample_count || sample_count == 0) {
        ...
        // when they activate
        std::cout << "ProximityData subscriber sleeping for 4 sec..." << std::endl;
