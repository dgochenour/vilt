...
* AnotherSimple.
*
* By default, this type is struct BrakeCommand
* itself. However, if for some reason this choice is not practical for your
* system (e.g. if sizeof(struct BrakeCommand)
* is very large), you may redefine this typedef in terms of another type of
* your choosing. HOWEVER, if you define the KeyHolder type to be something
* other than struct AnotherSimple, the
* following restriction applies: the key of struct
* BrakeCommand must consist of a
* single field of your redefined KeyHolder type and that field must be the
* first field in struct BrakeCommand.
*/
typedef  class BrakeCommand BrakeCommandKeyHolder;

#define BrakeCommandPlugin_get_sample PRESTypePluginDefaultEndpointData_getSample

#define BrakeCommandPlugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
#define BrakeCommandPlugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer

#define BrakeCommandPlugin_get_key PRESTypePluginDefaultEndpointData_getKey 
#define BrakeCommandPlugin_return_key PRESTypePluginDefaultEndpointData_returnKey

#define BrakeCommandPlugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
#define BrakeCommandPlugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 
...
BrakeCommandPluginSupport_create_data_w_params(
    const struct DDS_TypeAllocationParams_t * alloc_params);

NDDSUSERDllExport extern BrakeCommand*
BrakeCommandPluginSupport_create_data_ex(RTIBool allocate_pointers);
...
BrakeCommandPluginSupport_copy_data(
    BrakeCommand *out,
    const BrakeCommand *in);

NDDSUSERDllExport extern void 
BrakeCommandPluginSupport_destroy_data_w_params(
    BrakeCommand *sample,
    const struct DDS_TypeDeallocationParams_t * dealloc_params);

NDDSUSERDllExport extern void 
BrakeCommandPluginSupport_destroy_data_ex(
    BrakeCommand *sample,RTIBool deallocate_pointers);
...
NDDSUSERDllExport extern void 
BrakeCommandPluginSupport_print_data(
    const BrakeCommand *sample,
    const char *desc,
    unsigned int indent);

NDDSUSERDllExport extern BrakeCommand*
BrakeCommandPluginSupport_create_key_ex(RTIBool allocate_pointers);

NDDSUSERDllExport extern BrakeCommand*
BrakeCommandPluginSupport_create_key(void);

NDDSUSERDllExport extern void 
BrakeCommandPluginSupport_destroy_key_ex(
    BrakeCommandKeyHolder *key,RTIBool deallocate_pointers);
...
NDDSUSERDllExport extern RTIBool 
BrakeCommandPlugin_deserialize(
    PRESTypePluginEndpointData endpoint_data,
    BrakeCommand **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
BrakeCommandPlugin_key_to_instance(
    PRESTypePluginEndpointData endpoint_data,
    BrakeCommand *instance, 
    const BrakeCommandKeyHolder *key);
...
/* Plugin Functions */
NDDSUSERDllExport extern struct PRESTypePlugin*
BrakeCommandPlugin_new(void);

NDDSUSERDllExport extern void
BrakeCommandPlugin_delete(struct PRESTypePlugin *);
